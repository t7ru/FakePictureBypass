...
@implementation t71PCServiceDelegate
...
- (BOOL)listener:(NSXPCListener *)listener shouldAcceptNewConnection:(NSXPCConnection *)connection {
    ...
    if (strcmp(pathbuf, "/usr/local/bin/FakePictureBypass_client") != 0) { // Change this path according to match the installation path of the process you want to allow to connect
    ...
    connection.exportedInterface = [NSXPCInterface interfaceWithProtocol:@protocol(t71XPCProtocol)];
    t71XPC *exportedObject = [t71XPC new];
