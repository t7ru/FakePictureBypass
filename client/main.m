...
#import "../t71XPCProtocol.h"

int main(int argc, char *argv[], char *envp[]) {
    // Setup a connection to our service
    NSXPCConnection *connection = [[NSXPCConnection alloc] initWithMachServiceName:@"com.t7rutweaks.fakepicturebypass"];
    connection.remoteObjectInterface = [NSXPCInterface interfaceWithProtocol:@protocol(t71XPCProtocol)];
    [connection resume];
